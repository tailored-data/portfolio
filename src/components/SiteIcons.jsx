 ...
 * Inline SVG icons.
 *
 * Inlined rather than pulled from an icon package so the site ships zero
 * extra dependencies and every icon inherits `currentColor` — meaning they
 * re-theme along with the text without any extra styling.
 */
